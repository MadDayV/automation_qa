...
from pages.elements_page import TextBoxPage, CheckBoxPage, WebTablePage, RadioButtonPage, ButtonsPage, LinksPage, \
...
class TestElements:
    ...
    class TestWebTable:
        @allure.title('Check add a person to the table')
